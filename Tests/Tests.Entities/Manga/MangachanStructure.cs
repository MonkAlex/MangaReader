...
namespace Tests.Entities.Manga
{
  ...
  public class MangachanStructure : TestClass
  {
    ...
    {
      var manga = await GetManga("http://mangachan.me/manga/15659-this-girlfriend-is-fiction.html").ConfigureAwait(false);
    ...
    {
      var manga = await GetManga("http://mangachan.me/manga/20138-16000-honesty.html").ConfigureAwait(false);
      await new Parser().UpdateContent(manga).ConfigureAwait(false);
