...
namespace Tests.Entities.Manga
{
  ...
  public class ReadmangaCensored : TestClass
  {
    ...
    // Censored
    // https://readmanga.live/school_teacher/vol2/10?mature=1

    [Test]
    public async Task NotCensoredReadmanga()
    {
      var manga = await Get(@"https://readmanga.live/black_butler_anthology_comic_rainbow_butler/vol1/6").ConfigureAwait(false);
    ...
    {
      var manga = await Get(@"https://readmanga.live/school_teacher/vol2/10?mature=1").ConfigureAwait(false);
